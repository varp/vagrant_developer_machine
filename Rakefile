...
task :default do
  DEFAULT_COMPONENTS = 'deps/* system/* gui/xfce devtools/git devtools/sublime3 devtools/vim devtools/languages/* devtools/languages/python/* devtools/perl/* devtools/languages/ruby/* configs/*'
